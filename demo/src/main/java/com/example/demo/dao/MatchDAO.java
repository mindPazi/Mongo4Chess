...
public class MatchDAO {
    ...
    // Document matchQuery = new Document("$match", new Document("$and",
    // Arrays.asList(
    // new Document("whiteElo", new Document("$gte", elomin).append("$lte",
    // elomax)),
    // new Document("blackElo", new Document("$gte", elomin).append("$lte",
    // elomax)),
    // new Document("result", new Document("$in", Arrays.asList("W", "D"))) // Conta
    // solo
    // // vittorie e
    // // pareggi
    // )));
    ...
    // matchCollection.aggregate(Arrays.asList(matchQuery, countQuery));
    //
